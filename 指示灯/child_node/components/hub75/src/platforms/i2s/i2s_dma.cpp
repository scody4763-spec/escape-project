...
LAT_BIT = 6,  // Latch signal (Arduino compatible: bit 6)
OE_BIT = 7,   // Output Enable (Arduino compatible: bit 7)
  // Bits 13-15: Unused
};
...
void I2sDma::configure_gpio() {
  ...
  int iomux_clock = I2S0O_BCK_OUT_IDX;
#else
  int iomux_signal_base = (ESP32_I2S_DEVICE == 0) ? I2S0O_DATA_OUT8_IDX : I2S1O_DATA_OUT8_IDX;
    int iomux_clock = (ESP32_I2S_DEVICE == 0) ? I2S1O_BCK_OUT_IDX : I2S1O_BCK_OUT_IDX;
#endif
  ...
  int8_t pin_map[16] = {
      ...
      config_.pins.g2,   // D4
      config_.pins.b2,   // D5
      config_.pins.lat,  // D6 - LAT (Arduino compatible)
      config_.pins.oe,   // D7 - OE (Arduino compatible)
      config_.pins.a,    // D8 - ADDR bit 0
      config_.pins.b,    // D9 - ADDR bit 1
      config_.pins.c,    // D10 - ADDR bit 2
      config_.pins.d,    // D11 - ADDR bit 3
      config_.pins.e,    // D12 - ADDR bit 4
      -1,                // D13 unused
      -1,                // D14 unused
      -1                 // D15 unused
  };
